            ...
            <div class="container container-md-fluid container-sm-fluid px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="./?page=home">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href=https://soundee.com/PLUSSOUTH>Soundee</a></li>
